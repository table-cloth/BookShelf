...
//    ViewGroup recentTagTmpContainer;
    ...
    private void updateCurrentTags() {
        ...
        ViewUtil.setTagInfoLargeDelete(TagsEditDialogActivity.this, tags, tagContainer, View.INVISIBLE);
//        tagContainer.invalidate();
    ...
    private void updateRecentTags() {
        ...
        recentTagContainer = ViewUtil.setTagInfoLarge(TagsEditDialogActivity.this, tagsLog, recentTagContainer, View.INVISIBLE);
